export const I16_BYTE_COUNT = 2
export const I32_BYTE_COUNT = 4
export const I64_BYTE_COUNT = 8
export const U16_BYTE_COUNT = 2
export const U32_BYTE_COUNT = 4
export const U64_BYTE_COUNT = 8
